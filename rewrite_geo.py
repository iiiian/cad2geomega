...
# assemble.geo.setup
assem = open(
    '/home/ian/Documents/GTM massmodel/geo_test/assemble.geo.setup', 'r')
path = '/home/ian/Documents/GTM massmodel/geo_test/'
obj_dir = '/home/ian/Documents/GTM massmodel/geo_new/'
...
for i in typelist:
    ...
    while ogeo_line:
        ...
        if v_pos_raw:
            ...
            ngeo.write(v_name+'.Position {'+vm_pos_raw[0][1]+'+'+str(n_v_pos[0])+'} {'+vm_pos_raw[0][2]+'+'+str(
                n_v_pos[1])+'} {'+vm_pos_raw[0][3]+'+'+str(n_v_pos[2])+'}')
            ngeo.write('\n')
